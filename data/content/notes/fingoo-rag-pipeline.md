...
"어제 삼성전자 실적 발표 봤어?" LLM에게 물으면 모릅니다. 학습 데이터에 없으니까요. 투자 분석 AI가 최신 시장 상황을 모르면 쓸모가 없습니다. 매일 경제 데이터를 수집해 시황을 생성하고, pgvector RAG로 제공하되 부족하면 실시간 웹 검색으로 보완하는 2단계 파이프라인을 구축한 과정을 정리합니다.
