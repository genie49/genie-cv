# 사용자님 기다려 봐요 저 열심히 일하고 있어요

LLM은 응답을 생성하는 데 수 초가 걸립니다. 그 동안 사용자에게 빈 화면을 보여주면? 이탈합니다. 핀구의 AI 채팅은 스트리밍 텍스트·도구 실행 상태·시각화 커맨드·인용이 동시에 흐르는 복합 인터페이스입니다. "AI가 열심히 일하고 있다"는 걸 사용자에게 실시간으로 보여주기 위해 Socket.io 기반 통신 위에서 이 모든 것을 어떻게 렌더링했는지 정리합니다.
